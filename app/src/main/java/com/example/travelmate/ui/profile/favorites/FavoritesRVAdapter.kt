...
import com.example.travelmate.ui.profile.uploads.UploadsRVAdapter
...
class FavoritesRVAdapter(
    ...
    RecyclerView.Adapter<FavoritesRVAdapter.AttractionsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: AttractionsViewHolder, position: Int) {
        ...
        holder.attractionInfoBinding.favoritesButton.isChecked = true
